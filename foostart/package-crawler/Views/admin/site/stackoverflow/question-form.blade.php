...
{!! Form::open(['route'=>['stackoverflow_question.post', 'id' => @$item->id],  'files'=>true, 'method' => 'post'])  !!}

    <!--BUTTONS-->
    <div class='btn-form'>
        <!-- DELETE BUTTON -->
        @if($item)
            <a href="{!! URL::route('stackoverflow_question.delete',['id' => @$item->id, '_token' => csrf_token()]) !!}"
