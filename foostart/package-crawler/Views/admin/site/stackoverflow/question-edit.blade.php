...
@section('title')
    {{ trans($plang_admin.'.pages.title-edit-question') }}
@stop
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">
                        {!!
                            '<i class="fa fa-pencil"></i>'.trans($plang_admin.'.pages.title-edit-question')
                        !!}
                    </h3>
                </div>
                ...
                <div class='panel-description'>
                    {!! trans($plang_admin.'.descriptions.question_form') !!}</h4>
                </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            @include('package-crawler::admin.site.stackoverflow.question-form')
