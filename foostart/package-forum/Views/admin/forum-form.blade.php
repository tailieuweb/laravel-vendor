...
{!! Form::open(['route'=>['forums.post', 'id' => @$item->id],  'files'=>true, 'method' => 'post'])  !!}

<!--BUTTONS-->
<div class='btn-form'>
    <!-- DELETE BUTTON -->
    @if($item)
        <a href="{!! URL::route('forums.delete',['id' => @$item->id, '_token' => csrf_token()]) !!}"
...
<div class="tab-content">
    ...
    @include('package-category::admin.partials.input_text', [
        ...
        'value' => @$item->forum_questions_title,
    ...
    @include('package-category::admin.partials.input_slug', [
        ...
        'value' => @$item->forum_questions_slug,
    ...
    @include('package-category::admin.partials.textarea', [
        ...
        'value' => @$item->forum_questions_description,
    ...
    'value' => @$item->forum_questions_overview,
    ...
    <div id="menu_3" class="tab-pane fade">
        ...
        @include('package-category::admin.partials.input_image', [
            ...
            'value' => @$item->forum_questions_image,
    ...
    @include('package-category::admin.partials.input_files', [
        ...
        'value' => @$item->forum_questions_files,
