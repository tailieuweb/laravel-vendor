<?php namespace Foostart\Forum\Controllers\Admin;
...
use Foostart\Forum\Validators\ForumValidator;
...
class ForumAdminController extends FooController
{
    ...
    public function __construct(Request $request)
    {
        ...
        //set language files
        $this->plang_admin = 'forum-admin';
        $this->plang_front = 'forum-front';

        //package name
        $this->package_name = 'package-forum';
        $this->package_base_name = 'forum';

        //root routers
        $this->root_router = 'forums';
        ...
        $this->category_ref_name = 'admin/forums';
    ...
    public function lang(Request $request)
    {
        ...
        if (!empty($langs) && is_array($langs)) {
            foreach ($langs as $key => $value) {
                $lang_paths[$key] = realpath(base_path('resources/lang/' . $key . '/forum-admin.php'));
        ...
        if ($request->isMethod('post') && $is_valid_request) {
            ...
            foreach ($lang_paths as $key => $value) {
                ...
                //format file name forum-admin-YmdHis.php
                file_put_contents($lang_bakup . '/' . $key . '/forum-admin-' . date('YmdHis', time()) . '.php', $content);
            }
