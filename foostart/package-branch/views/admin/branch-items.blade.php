...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-info">
                    ...
                    <div class='panel-info panel-description'>
                        ...
                        @if($is_admin)
                        <p>You are admin, <a href="{!! Url::route('branch.list',['user_id' => $user_id]) !!}">click here</a> to view your created rules
                        @endif
                    </div>
                    <!--/DESCRIPTION-->
                    ...
                    <div class="panel-body">
                        {!! Form::open(['route'=>['branch.delete', 'id' => @$item->id], 'method' => 'get'])  !!}

                            @include('package-branch::admin.branch-item')
            ...
            <!--SEARCH-->
            <div class="col-md-3">
                @include('package-branch::admin.branch-search')
            </div>
            <!--/SEARCH-->
