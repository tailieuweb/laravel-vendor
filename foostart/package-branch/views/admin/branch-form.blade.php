<!------------------------------------------------------------------------------
| List of elements in branch form
|------------------------------------------------------------------------------->

{!! Form::open(['route'=>['branch.branch', 'id' => @$item->id],  'files'=>true, 'method' => 'branch'])  !!}

    <!--BUTTONS-->
    <div class='btn-form'>
        <!-- DELETE BUTTON -->
        @if($item)
            <a href="{!! URL::route('branch.delete',['id' => @$item->id, '_token' => csrf_token()]) !!}"
...
{!! Form::close() !!}
<!------------------------------------------------------------------------------
| End list of elements in branch form
|------------------------------------------------------------------------------>
