...
class GroupController extends Controller
{
    ...
    public function postEditGroup(Request $request)
    {
        ...
        try {
            ...
            return Redirect::route("groups.edit.get", $id ? ["id" => $id] : [])->withInput()->withErrors($errors);
        }
        return Redirect::route('groups.edit.get', ["id" => $obj->id])->withMessage(Config::get('acl_messages.flash.success.group_edit_success'));
    }
    ...
    public function editPermission(Request $request)
    {
        ...
        try {
            ...
            return Redirect::route("users.groups.edit.get")->withInput()->withErrors(new MessageBag(["permissions" => Config::get('acl_messages.flash.error.group_permission_not_found')]));
        }
        return Redirect::route('groups.edit.get', ["id" => $obj->id])->withMessage(Config::get('acl_messages.flash.success.group_permission_edit_success'));
    }
}
