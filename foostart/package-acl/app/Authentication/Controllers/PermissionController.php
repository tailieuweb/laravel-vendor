...
class PermissionController extends Controller
{
    ...
    public function postEditPermission(Request $request)
    {
        ...
        try {
            ...
            return Redirect::route("permissions.edit.get", $id ? ["id" => $id] : [])->withInput()->withErrors($errors);
        }

        return Redirect::route("permissions.edit.get", ["id" => $obj->id])->withMessage(Config::get('acl_messages.flash.success.permission_permission_edit_success'));
    }
