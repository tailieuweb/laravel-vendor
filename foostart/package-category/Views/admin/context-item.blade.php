    ...
    <div class="table-responsive" style="width: 950px">
        <table class="table table-hover">
            ...
            <tr style="height: 50px;">
                ...
                <th class="hidden-xs"
                    style='width:{{ $withs['name'] }}'>{!! trans($plang_admin.'.columns.context-name') !!}
                ...
                <th class="hidden-xs"
                    style='width:{{ $withs['name'] }}'>{!! trans($plang_admin.'.columns.context-ref') !!}
                    <a href='{!! $sorting["url"][$name] !!}' class='tb-id' data-order='asc'>
                        @if($sorting['items'][$name] == 'asc')
                            <i class="fa fa-sort-alpha-asc" aria-hidden="true"></i>
                        @elseif($sorting['items'][$name] == 'desc')
                ...
                <th class="hidden-xs text-center"
                    style='width:{{ $withs['name'] }}'>{!! trans($plang_admin.'.columns.context-status') !!}
                    <a href='{!! $sorting["url"][$name] !!}' class='tb-id' data-order='asc'>
                        @if($sorting['items'][$name] == 'asc')
                            <i class="fa fa-sort-alpha-asc" aria-hidden="true"></i>
                        @elseif($sorting['items'][$name] == 'desc')
